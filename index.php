    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#66CCFF">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#FFFFFF">Echo Survey</a>
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('images/feedbac1.jpg');"></div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('images/feedbac2.jpg');"></div>
                <div class="carousel-caption">
			 ...
			 <div class="item">
                <div class="fill" style="background-image:url('images/Feedbac3');"></div>
                <div class="carousel-caption">
...
<!-- slider -->			
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <h1 style="margin: 0; font-size: 2.5rem;">Online Student Feedback System</h1>
            <p style="margin: 10px 0 0; font-size:medium">Share your feedback, improve your learning environment!</p>
				<h2>WELCOME</h2>
				Our system empowers students to provide feedback about their educational experience. 
            Your voice matters and helps us create a better environment for learning and growth.
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:black">Developed By <a href="" style="color:azure">Purba Das @ 2024</a> </span>
	</div>
    <!-- jQuery -->
